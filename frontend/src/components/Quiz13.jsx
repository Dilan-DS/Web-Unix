...
import { preguntasSemana13 } from '../data/preguntasSemana13'
...
const Quiz13 = () => {
  ...
  useEffect(() => {
    const preguntasAleatorias = obtenerPreguntasAleatorias(preguntasSemana13, 10)
  ...
  const calcularResultados = () => {
    ...
    // ✅ Guardar progreso y nota
    marcarParteComoCompletada('semana13', 'quiz')
    guardarNotaQuiz('semana13', puntos)
  }

  const reiniciarQuiz = () => {
    setPreguntas(obtenerPreguntasAleatorias(preguntasSemana13, 10))
    setRespuestas({})
    setPreguntaActual(0)
    setPuntaje(0)
