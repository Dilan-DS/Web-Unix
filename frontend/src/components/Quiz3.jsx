...
import { preguntasSemana3 } from '../data/preguntasSemana3'
...
const Quiz3 = () => {
  ...
  useEffect(() => {
    const preguntasAleatorias = obtenerPreguntasAleatorias(preguntasSemana3, 10)
  ...
  const calcularResultados = () => {
    ...
    // Guarda progreso y nota en localStorage
    marcarParteComoCompletada('semana3', 'quiz')
    guardarNotaQuiz('semana3', puntos)
  }

  const reiniciarQuiz = () => {
    setPreguntas(obtenerPreguntasAleatorias(preguntasSemana3, 10))
    setRespuestas({})
    setPreguntaActual(0)
    setPuntaje(0)
