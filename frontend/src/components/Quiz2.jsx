...
import { preguntasSemana2 } from '../data/preguntasSemana2'
...
const Quiz2 = () => {
  ...
  useEffect(() => {
    const preguntasAleatorias = obtenerPreguntasAleatorias(preguntasSemana2, 10)
  ...
  const calcularResultados = () => {
    ...
    marcarParteComoCompletada('semana2', 'quiz')
    guardarNotaQuiz('semana2', puntos)
  }

  const reiniciarQuiz = () => {
    setPreguntas(obtenerPreguntasAleatorias(preguntasSemana2, 10))
    setRespuestas({})
    setPreguntaActual(0)
    setPuntaje(0)
