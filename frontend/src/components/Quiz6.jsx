...
import { preguntasSemana6 } from '../data/preguntasSemana6'
...
const Quiz6 = () => {
  ...
  useEffect(() => {
    const preguntasAleatorias = obtenerPreguntasAleatorias(preguntasSemana6, 10)
  ...
  const calcularResultados = () => {
    ...
    marcarParteComoCompletada('semana6', 'quiz')
    guardarNotaQuiz('semana6', puntos)
  }

  const reiniciarQuiz = () => {
    setPreguntas(obtenerPreguntasAleatorias(preguntasSemana6, 10))
    setRespuestas({})
    setPreguntaActual(0)
    setPuntaje(0)
