...
import { preguntasSemana7 } from '../data/preguntasSemana7';
...
const Quiz7 = () => {
  ...
  useEffect(() => {
    const preguntasAleatorias = obtenerPreguntasAleatorias(preguntasSemana7, 10);
  ...
  const calcularResultados = () => {
    ...
    marcarParteComoCompletada('semana7', 'quiz');
    guardarNotaQuiz('semana7', puntos);
  };

  const reiniciarQuiz = () => {
    setPreguntas(obtenerPreguntasAleatorias(preguntasSemana7, 10));
    setRespuestas({});
    setPreguntaActual(0);
    setPuntaje(0);
