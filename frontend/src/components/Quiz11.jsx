...
import { preguntasSemana11 } from '../data/preguntasSemana11'
...
const Quiz11 = () => {
  ...
  useEffect(() => {
    const preguntasAleatorias = obtenerPreguntasAleatorias(preguntasSemana11, 10)
  ...
  const calcularResultados = () => {
    ...
    marcarParteComoCompletada('semana11', 'quiz')
    guardarNotaQuiz('semana11', puntos)
  }

  const reiniciarQuiz = () => {
    setPreguntas(obtenerPreguntasAleatorias(preguntasSemana11, 10))
    setRespuestas({})
    setPreguntaActual(0)
    setPuntaje(0)
