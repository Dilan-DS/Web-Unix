...
import preguntasSemana8 from '../data/preguntasSemana8'; // ✅ IMPORTACIÓN CORRECTA
...
const Quiz8 = () => {
  ...
  useEffect(() => {
    const preguntasAleatorias = obtenerPreguntasAleatorias(preguntasSemana8, 10); // ✅ USO CORRECTO
  ...
  const reiniciarQuiz = () => {
    setPreguntas(obtenerPreguntasAleatorias(preguntasSemana8, 10)); // ✅ USO CORRECTO
    setRespuestas({});
    setPreguntaActual(0);
    setPuntaje(0);
