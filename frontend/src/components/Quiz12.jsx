...
import { preguntasSemana12 } from '../data/preguntasSemana12'
...
const Quiz12 = () => {
  ...
  useEffect(() => {
    const preguntasAleatorias = obtenerPreguntasAleatorias(preguntasSemana12, 10)
  ...
  const calcularResultados = () => {
    ...
    marcarParteComoCompletada('semana12', 'quiz')
    guardarNotaQuiz('semana12', puntos)
  }

  const reiniciarQuiz = () => {
    setPreguntas(obtenerPreguntasAleatorias(preguntasSemana12, 10))
    setRespuestas({})
    setPreguntaActual(0)
    setPuntaje(0)
